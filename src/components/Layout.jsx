  ...
  return <div className="app-shell">
    ...
    <header className="site-header">
      <div className="header-main">
        ...
        <form className="header-search" action="/shop"><input name="search" placeholder="Search for products, brands and categories..."/><button aria-label="Search">⌕</button></form>
        <div className="header-actions">
          <Link className="header-action" to="/account"><span className="action-icon">♙</span><span><small>Welcome</small><b>Account</b></span></Link>
          <Link className="header-action" to="/wishlist"><span className="action-icon">♡</span><span><small>Saved</small><b>Wishlist {wishlistCount > 0 && `(${wishlistCount})`}</b></span></Link>
    ...
    <footer className="site-footer">
      ...
      <div><h4>Customer Care</h4><Link to="/account">My account</Link><Link to="/wishlist">Wishlist</Link><Link to="/contact">Help & contact</Link><Link to="/cart">Shopping cart</Link></div>
